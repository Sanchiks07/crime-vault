    ...
    public function run(): void
    {
        DB::table('victims')->insert([
            ...
            [
                ...
                'count' => json_encode([
                    'killed' => [
                        ...
                        ['name' => 'James Byron Haakenson', 'age' => 16],
            ...
            [
                ...
                'count' => json_encode([
                    'killed' => [
                        ['name' => 'Yolanda Washington', 'age' => 17],
                        ['name' => 'Judith Lynn Miller', 'age' => 15],
                        ['name' => 'Nancy Jo Baird', 'age' => 21],
                        ['name' => 'Debra Jackson', 'age' => 32],
                        ['name' => 'Linda Lee Sparks', 'age' => 18],
                        ['name' => 'Sonja Johnson', 'age' => 14],
                        ['name' => 'Maria Hernandez', 'age' => 21],
                        ['name' => 'Mignon DuFree', 'age' => 15],
                        ['name' => 'Yolanda Johnson', 'age' => 21],
                        ['name' => 'Jacqueline Lamotte', 'age' => 15],
                        ['name' => 'Cindy Hudspeth', 'age' => 20],
                        ['name' => 'Diane Wilder', 'age' => 27],
                        ['name' => 'Kimberly Nelson', 'age' => 22],
                    ],
                    'wounded' => []
                ])
            ],

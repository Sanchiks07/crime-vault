    ...
    <div class="py-12 bg-bg text-text">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-10">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="bg-surface border border-primary shadow-sm rounded-lg p-5">
                        ...
                        <p class="text-sm text-text/70">Detailed profiles, timelines, and victim data. Study patterns and methods.</p>
                    </div>

                    <div class="bg-surface border border-primary shadow-sm rounded-lg p-5">
                        <h3 class="text-lg font-semibold mb-2 text-text">Unsolved Cases</h3>
                        <p class="text-sm text-text/70">Cold cases and mysteries that remain unanswered. Evidence, suspects, and theories.</p>
                    </div>

                    <div class="bg-surface border border-primary shadow-sm rounded-lg p-5">
                        <h3 class="text-lg font-semibold mb-2 text-text">Criminal Psychology</h3>
                        <p class="text-sm text-text/70">Dive into motives, behavioral patterns, and psychological analysis.</p>
                    </div>

                    <div class="bg-surface border border-primary shadow-sm rounded-lg p-5">
                        <h3 class="text-lg font-semibold mb-2 text-text">Victims</h3>
                        <p class="text-sm text-text/70">A dedicated space for those affected - focusing on their lives and stories.</p>
                    </div>
                    ...
                    <div class="bg-surface border border-primary shadow-sm rounded-lg p-5 sm:col-span-2 lg:col-span-1">
                        ...
                        <p class="text-sm text-text/70">Research materials, references, and tools for deeper exploration.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-surface border border-primary shadow-sm rounded-lg p-6">
                    ...
                    <div id="featured-case">
                        ...
                        <p id="fc-type" class="text-sm text-text/60 mb-2"></p>
                        <p id="fc-description" class="text-text/80 mb-3"></p>
            ...
            <div class="bg-surface border border-primary shadow-sm rounded-lg p-8 text-center">
                ...
                <p class="text-text/80 mb-4">Choose a path and begin digging into the archive.</p>
